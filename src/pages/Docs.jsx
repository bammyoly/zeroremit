...
function SubSection({ title, children }) {
  return (
    <div className="mb-6">
      <h3 className="text-[11px] font-bold font-mono uppercase tracking-widest text-zinc-300 mb-3">
        {title}
      </h3>
      <div className="space-y-3 text-sm text-zinc-400 font-sans normal-case leading-relaxed">
        {children}
      </div>
    </div>
  );
        ...
        <thead>
          <tr className="border-b border-zinc-800/60">
            {['Field', 'Type', 'Required', 'Description'].map(h => (
              <th key={h} className="px-3 py-2 text-left text-[10px] font-bold text-zinc-600 uppercase tracking-widest">
                {h}
              </th>
            ))}
          </tr>
        ...
        <tbody>
          {rows.map((row, i) => (
            <tr key={i} className={`border-b border-zinc-800/40 ${i % 2 ? 'bg-zinc-900/20' : ''}`}>
              ...
              <td className="px-3 py-2.5 text-zinc-500">{row.required ? 'Yes' : 'No'}</td>
              <td className="px-3 py-2.5 text-zinc-400">{row.desc}</td>
            </tr>
          ))}
        </tbody>
      </table>
  ...
  return (
    <div className="border border-zinc-800/60 bg-zinc-950/40 mb-4">
      <div className="flex items-center gap-3 px-4 py-3 border-b border-zinc-800/60">
        ...
        <code className="text-[11px] font-mono text-zinc-200 break-all">{path}</code>
      </div>
      <div className="px-4 py-3 space-y-3">
        <p className="text-[11px] font-mono text-zinc-400">{desc}</p>
        {auth && (
        ...
        {params && (
          <div>
            <p className="text-[9px] font-bold font-mono text-zinc-600 uppercase tracking-widest mb-1">
              Body / Query
            </p>
...
function ArchDiagram({ lines }) {
  return (
    <div className="bg-zinc-950/60 border border-zinc-800 p-4 font-mono text-[11px] text-zinc-400 leading-relaxed overflow-x-auto">
      {lines.map((line, i) => (
  ...
  return (
    <>
      <DocSection id="what-is-zeroremit" title="What is Zeroremit">
        ...
        <p>
          Invoice amounts are encrypted using <strong className="text-zinc-200">Zama's Fully Homomorphic Encryption (FHE)</strong> directly
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={step} className="flex gap-4 items-start px-4 py-3 border border-zinc-800/40 bg-zinc-950/40">
              ...
              <div>
                <p className="text-[10px] font-bold font-mono text-zinc-200 uppercase tracking-wide mb-0.5">
                  {step}
                </p>
                <p className="text-[11px] font-mono text-zinc-500">{desc}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={item.term} className="pl-4 border-l-2 border-zinc-800 py-1">
              <p className="text-[10px] font-bold font-mono text-zinc-200 uppercase tracking-wide mb-1">
                {item.term}
              </p>
              <p className="text-[11px] font-mono text-zinc-500 leading-relaxed">{item.def}</p>
            </div>
          ))}
        </div>
      </DocSection>
        ...
        <SubSection title="Responsibilities">
          <ul className="space-y-1.5">
            {[
              ...
              <li key={i} className="flex gap-2.5 items-start text-[11px] font-mono text-zinc-400">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={item.fn} className="px-3 py-2 border border-zinc-800/40 bg-zinc-950/40">
                ...
                <p className="text-[11px] font-mono text-zinc-500">{item.desc}</p>
              </div>
            ))}
          </div>
        </SubSection>
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={item.type} className={`pl-4 border-l-2 ${item.color} py-2`}>
              <p className="text-[10px] font-bold font-mono text-zinc-200 uppercase tracking-wide mb-2">
                {item.type}
              </p>
              <ul className="space-y-1">
                {item.items.map((s, i) => (
                  <li key={i} className="flex gap-2 text-[11px] font-mono text-zinc-500">
                    <span className="text-sky-400 flex-shrink-0">·</span>
                    {s}
                  </li>
                ))}
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={item.event} className="flex flex-col sm:flex-row items-start gap-3 px-3 py-2 border border-zinc-800/40 bg-zinc-950/40">
              ...
              <span className="text-[9px] font-mono text-zinc-600 flex-shrink-0">{item.contract}</span>
            </div>
          ))}
        </div>
        <InfoBox type="info">
  ...
  return (
    <>
      <DocSection id="fhe-overview" title="FHE overview">
        ...
        <p>
          Zeroremit uses Zama's <strong className="text-zinc-200">fhEVM</strong> — a version
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={scheme} className="pl-4 border-l-2 border-zinc-800 py-1">
                <p className="text-[10px] font-bold font-mono text-zinc-300 uppercase tracking-wide mb-1">{scheme}</p>
                <p className="text-[11px] font-mono text-zinc-500">{desc}</p>
              </div>
            ))}
          </div>
        ...
        <SubSection title="Setup">
          <div className="space-y-2">
            {[
              ...
              <p key={i} className="text-[11px] font-mono text-zinc-400">{s}</p>
            ))}
          </div>
        </SubSection>
        ...
        <SubSection title="What the burner can do">
          <ul className="space-y-1">
            {[
              ...
              <li key={i} className="flex gap-2 text-[11px] font-mono text-zinc-400">
  ...
  return (
    <>
      <DocSection id="authentication" title="Authentication">
        ...
        <div className="bg-zinc-950/60 border border-zinc-800 px-4 py-3 font-mono text-[11px] text-zinc-400 mb-4 break-all">
        ...
        <div className="space-y-1.5">
          {[
            ...
            <div key={code} className="flex flex-col sm:flex-row items-start gap-3 px-3 py-2.5 border border-zinc-800/40 bg-zinc-950/40">
              ...
              <code className="text-[11px] font-mono text-zinc-300 flex-shrink-0 sm:w-36">{name}</code>
              <p className="text-[11px] font-mono text-zinc-500">{desc}</p>
            </div>
          ))}
        </div>
          ...
          {[
            ...
            <div key={item.actor} className="border border-zinc-800/60 bg-zinc-950/40 overflow-hidden">
              <div className="px-4 py-2 border-b border-zinc-800/60">
                <p className="text-[10px] font-bold font-mono text-zinc-300 uppercase tracking-widest">{item.actor}</p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-zinc-800/60">
                <div className="px-4 py-3">
                  ...
                  {item.can.map((s, i) => (
                    <div key={i} className="flex gap-2 text-[11px] font-mono text-zinc-500 mb-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {[
            ...
            <div key={item.layer} className="border border-zinc-800/40 bg-zinc-950/40 p-4">
              ...
              <div className="space-y-1">
                {item.items.map(s => (
                  <div key={s} className="flex gap-2 text-[11px] font-mono text-zinc-500">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={title} className="pl-4 border-l-2 border-zinc-800 py-1">
                <p className="text-[10px] font-bold font-mono text-zinc-300 uppercase tracking-wide mb-1">{title}</p>
                <p className="text-[11px] font-mono text-zinc-500">{desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-1.5">
            {[
              ...
              <div key={param} className="flex flex-col sm:flex-row items-start gap-3 px-3 py-2 border border-zinc-800/40 bg-zinc-950/40">
                ...
                <span className="text-[10px] font-mono text-zinc-300 flex-shrink-0 sm:w-24">{value}</span>
                <p className="text-[11px] font-mono text-zinc-500">{desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <div className="p-3 border border-zinc-800/40 bg-zinc-950/40">
              ...
              {['SingleInvoiceCreated', 'MultiInvoiceCreated', 'InvoicePaid', 'InvoiceItemPaid', 'InvoiceCancelled', 'InvoiceExpired'].map(e => (
                <div key={e} className="flex gap-2 text-[11px] font-mono text-zinc-500 mb-0.5">
      ...
      <DocSection id="backend-bot" title="Telegram bot">
        ...
        <SubSection title="Balance command">
          <p>
            ...
            cUSDC balances are shown as <code className="text-zinc-400 text-[11px]">[encrypted]</code> since
          ...
          <div className="space-y-1.5">
            {[
              ...
              <div key={header} className="flex flex-col sm:flex-row items-start gap-3 px-3 py-2 border border-zinc-800/40 bg-zinc-950/40">
                ...
                <code className="text-[10px] font-mono text-zinc-400">{value}</code>
              </div>
            ))}
          </div>
        </SubSection>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
            {[
              ...
              <div key={attempt} className="px-3 py-2 border border-zinc-800/40 bg-zinc-950/40 text-center">
                <p className="text-[10px] font-bold font-mono text-zinc-300">#{attempt}</p>
                <p className="text-[10px] font-mono text-zinc-600">{delay}</p>
              </div>
            ))}
          </div>
        </SubSection>
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={step} className="flex gap-4 items-start px-4 py-3 border border-zinc-800/40 bg-zinc-950/40">
                ...
                <div>
                  <p className="text-[10px] font-bold font-mono text-zinc-200 uppercase tracking-wide mb-0.5">{title}</p>
                  <p className="text-[11px] font-mono text-zinc-500">{desc}</p>
                </div>
              </div>
            ))}
        ...
        <div className="space-y-1.5">
          {[
            ...
            <div key={name} className="flex flex-col sm:flex-row items-start gap-3 px-3 py-2.5 border border-zinc-800/40 bg-zinc-950/40">
              ...
              <code className="text-[10px] font-mono text-zinc-500 flex-shrink-0 sm:w-52 break-all">{example}</code>
              <p className="text-[11px] font-mono text-zinc-400">{desc}</p>
            </div>
          ))}
        </div>
      ...
      <div className="relative z-10">
        ...
        <section className="relative pt-36 pb-20 px-4 border-b border-zinc-900/60 text-center overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <p className="text-sm text-zinc-400 max-w-2xl mx-auto leading-relaxed font-sans normal-case mb-8">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-0 overflow-x-auto px-4 sm:px-6 scrollbar-hide">
              ...
              <button
                ...
                className="ml-auto lg:hidden flex items-center gap-2 text-[10px] font-mono text-zinc-500 hover:text-zinc-300 uppercase tracking-widest px-3">
        ...
        <div className="flex max-w-7xl mx-auto">
          ...
          `}>
            <div className="p-4 space-y-1">
              <p className="text-[9px] font-bold font-mono text-zinc-700 uppercase tracking-widest px-2 py-1 mb-2">
                {currentTab?.label}
              </p>
                ...
                <button
                  ...
                  className={`w-full text-left px-3 py-2 text-[11px] font-mono transition-all ${
                    activeSection === section.id
                      ...
                      : 'text-zinc-500 hover:text-zinc-300 hover:bg-zinc-900/20 border-l-2 border-transparent pl-2.5'
                  }`}>
                  {section.label}
                </button>
              ))}
          ...
          <div className="hidden xl:block w-48 flex-shrink-0 sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto p-6">
            <p className="text-[9px] font-bold font-mono text-zinc-700 uppercase tracking-widest mb-3">
              On this page
            </p>
            {currentTab?.sections.map(section => (
              <button
